...
"""
TCP Gateway TCP benchmark.

Benchmark the TCP connectivity endpoints.
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="TCP Gateway TCP benchmark.",
    ...
    parser.add_argument(
        ...
        choices=("check", "wait"),
        default="check",
        help="TCP endpoint to benchmark.",
    )
...
def main() -> int:
    ...
    endpoint = f"{args.url}{args.api_prefix}/tcp/{args.endpoint}"
